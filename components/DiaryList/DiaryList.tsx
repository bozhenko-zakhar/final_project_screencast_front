...
const DiaryList = ({ onSelectEntry }: { onSelectEntry?: (entryId: string) => void }) => {
  const { entries, isLoading, error, fetchEntries } = useDiaryStore();
